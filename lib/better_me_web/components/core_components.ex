defmodule BetterMeWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: BetterMeWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BetterMeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BetterMeWeb.Gettext, "errors", msg, opts)
    end
  end
