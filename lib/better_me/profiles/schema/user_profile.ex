defmodule BetterMe.Profiles.Schema.UserProfile do
  ...
  def changeset(profile, attrs) do
    profile
    |> cast(attrs, [:age, :weight_kg, :height_cm, :gender, :activity_level, :protein_pct, :carbs_pct])
    |> validate_required([:age, :weight_kg, :height_cm, :gender, :activity_level, :protein_pct, :carbs_pct])
